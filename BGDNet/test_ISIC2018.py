...
from models.MSDUnet import MSDUFormer_Xnet_3463_FUESMS_raw
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth_path', type=str, default='/zjy_work/MSDUNet-main/model_out/ISIC2018-4/ISIC2018_FAUFormer_GlobalKV/ISIC2018_FAUFormer_GlobalKV-best.pth')
