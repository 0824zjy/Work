...
def main():
    ...
    summary_df = pd.DataFrame([{
        ...
        "Boundary-F1": round(summary["boundary_f1"], 6),
        "Boundary-IoU": round(summary["boundary_iou"], 6),
    }])
    ...
    print(f"Boundary-F1: {summary['boundary_f1']:.6f}")
    print(f"Boundary-IoU:{summary['boundary_iou']:.6f}")
    print("*****************************************************")
    print(f"Per-image metrics saved to: {per_csv}")
    print(f"Summary metrics saved to:   {summary_csv}")
    print(f"Masks saved to:             {mask_dir}")
    print(f"Boundaries saved to:        {bnd_dir}")
