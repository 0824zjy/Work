...
STAGE1_EXP="stage1_bef_sbg"
EXP_NAME="stage2_bef_sbg_decoder"
...
# 默认接 stage1 last.ckpt，也可外部覆盖：
# RESUME_PATH=/path/to/stage1_or_best.ckpt bash stage2_bef_sbg.sh
...
# Stage2: train decoder/output blocks and boundary modulators.
export SD_LOCKED=0
...
# Stage2 enables weak decoder modulation.
...
LOG_FILE="${LOG_ROOT}/${EXP_NAME}/train_stage2_bef_sbg_$(date +%Y%m%d_%H%M%S).log"
PID_FILE="${PID_DIR}/stage2_bef_sbg.pid"
...
echo "[OK] BEF-SBG Stage2 training started."
echo "     exp:    ${EXP_NAME}"
