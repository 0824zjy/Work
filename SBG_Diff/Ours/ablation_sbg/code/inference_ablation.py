...
def parse_args():
    ...
    # Default: mask-only inference.
    # Soft boundary prior is automatically generated from mask inside model.get_input.
    p.add_argument(
        "--use_image_control",
        action="store_true",
...
def get_model():
    ...
    # strict=False is important because SBP-PG introduces new weak boundary modules.
...
def log_local(save_dir, images, global_index, sample_index=None):
    ...
    # New soft boundary prior.
    # This should be grayscale continuous, not binary.
    ...
    # Optional hard boundary visualization.
