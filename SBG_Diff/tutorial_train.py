...
# This file can be copied to /data/zjy_work/BGDiff/tutorial_train.py
...
#   share, tutorial_dataset, cldm, ldm
# ---------------------------------------------------------------------
...
GLOBAL_SEED = int(os.environ.get("DIFF_SEED", os.environ.get("PL_GLOBAL_SEED", "42")))
...
# ============================================================
# Required because SBP-PG / ablation framework introduces optional params:
#   - image_hint_block
#   - boundary_modulators
#   - soft/hard/no boundary prior modes
# and must tolerate old checkpoint structure.
# ============================================================
...
#   SD_LOCKED=0
#   -> decoder/output blocks and boundary modulation trainable
# ============================================================
...
if train_unet_decoder or not args.sd_locked:
...
print_config_block(
    "SBP-PG / Ablation Boundary Config",
    [
        "BOUNDARY_PRIOR_MODE",
