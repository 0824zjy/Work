...
class ControlLDM(LatentDiffusion):
    ...
    def __init__(self, control_stage_config, control_key, only_mid_control, *args, **kwargs):
        ...
        self.aug_easy_bias = float(os.environ.get("AUG_EASY_BIAS", "1.0"))  # 简单 mask 更容易被增强
    ...
    def _estimate_morph_complexity(self, mask):
        """
        返回每个样本的复杂度分数，范围近似 [0,1]
        基于面积、周长、紧致度(compactness)
        """
    ...
    def _morphology_balanced_online_aug(self, mask):
        """
        根据 morphology complexity 决定增强概率：
        - 简单 mask 更高概率增强
        - 复杂 mask 更保守
        """
        mask = self._to_single_channel_mask(mask)
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        # ============================================================
        # loss 3: morphology-balanced online augmentation
        # ============================================================
        if self.enable_online_aug:
            ...
            model_output_aug = self.apply_model(x_noisy, t, cond_aug)
